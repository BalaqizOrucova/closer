<div class="panel panel-default panel-post" id="panel-post-{{ $post->id }}">
    <div class="panel-body">
        <div class="pull-left">
            <a href="#">
                <img style="width:50px;height:50px" class="media-object img-circle post-profile-photo" src="{{ $post->user->getPhoto() }}">
            </a>
        </div>
            ...
            <form id="form-new-comment">
                <div class="pull-left">
                    <a href="{{ url('/'.$user->username) }}">
                        <img style = "width:50px;height:50px" class="media-object img-circle" src="{{ $user->getPhoto() }}">
                    </a>
                </div>
